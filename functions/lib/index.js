        ...
        try {
            ...
            return response.status(200).json({
                ...
                result: {
                    ...
                    analysis: ((_b = (_a = openaiResponse.choices[0]) === null || _a === void 0 ? void 0 : _a.message) === null || _b === void 0 ? void 0 : _b.content) || '',
                }
            });
        }
        catch (error) {
...
exports.generateCorrection = functions.https.onRequest((request, response) => {
    corsHandler(request, response, async () => {
        ...
        try {
            ...
            if ((homeworkData === null || homeworkData === void 0 ? void 0 : homeworkData.user_id) !== uid) {
...
${homeworkData === null || homeworkData === void 0 ? void 0 : homeworkData.analysis}
...
Sois pédagogique, précis et adapte ton explication au niveau scolaire approprié.`;
            ...
            const correction = (_b = (_a = data.choices[0]) === null || _a === void 0 ? void 0 : _a.message) === null || _b === void 0 ? void 0 : _b.content;
...
exports.getStats = functions.https.callable(async (data, context) => {
    ...
    try {
        ...
        const homeworkData = querySnapshot.docs.map(doc => (Object.assign({ docId: doc.id }, doc.data())));
        ...
        const performances = performanceSnapshot.docs.map(doc => (Object.assign({ id: doc.id }, doc.data())));
        return {
            homeworkData,
            performances,
        ...
        throw new functions.https.HttpsError('internal', 'Failed to retrieve user statistics data.');
    }
});
